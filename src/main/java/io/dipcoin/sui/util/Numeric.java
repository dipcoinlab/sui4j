...
import io.dipcoin.sui.protocol.exceptions.MessageDecodingException;
import io.dipcoin.sui.protocol.exceptions.MessageEncodingException;
...
/**
 * @author : Same
 * @datetime : 2025/6/25 22:26
 * @Description : Message codec functions.
 */
public class Numeric {
    ...
    public static BigInteger decodeQuantity(String value) {
        ...
        if (!isValidHexQuantity(value)) {
            throw new MessageDecodingException("Value must be in format [0-9a-fA-F]+");
        }
    ...
    public static byte[] base58ToBytes(String base58) {
        ...
        // Here uses a simplified implementation, actual projects may need more complete Base58 library
        try {
            // For Sui digest, usually uses Base64 encoding
            return Base58.decode(base58);
        } catch (IllegalArgumentException e) {
            // If not Base64, try other encoding methods
