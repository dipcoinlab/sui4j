...
/**
 * @author : Same
 * @datetime : 2025/6/25 19:09
 * @Description : SUI Services API
 */
public interface SuiService {
    ...
    /**
     * Subscribe to a stream of notifications. A stream of notifications is opened by performing
     ...
     * client unsubscribes from this Flowable the service unsubscribes from the underlying stream of events.
     *
     * @param request JSON-RPC request that will be send to subscribe to a stream of events
     * @param unsubscribeMethod method that will be called to unsubscribe from a stream of notifications
