...
/**
 * @author : Same
 * @datetime : 2025/6/30 17:37
 * @Description : Move MutableReference mutable reference type response
 */
@Data
@JsonIgnoreProperties(ignoreUnknown = true)
public class MutableReferenceType extends SuiMoveNormalizedType {
