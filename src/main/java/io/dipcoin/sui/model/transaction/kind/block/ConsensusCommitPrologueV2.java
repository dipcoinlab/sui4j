 ...
 * @Description : ConsensusCommitPrologueV2 response
 */
@Data
@JsonIgnoreProperties(ignoreUnknown = true)
public class ConsensusCommitPrologueV2 extends TransactionBlockKind {
    ...
    public ConsensusCommitPrologueV2() {
        this.kind = "ConsensusCommitPrologueV2";
    }
}
