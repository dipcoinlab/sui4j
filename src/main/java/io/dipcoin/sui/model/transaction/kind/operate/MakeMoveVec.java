...
/**
 * @author : Same
 * @datetime : 2025/6/27 22:33
 * @Description : MakeMoveVec response
 */
...
public class MakeMoveVec extends SuiTransaction {

    @JsonProperty("MakeMoveVec")
    private MakeMoveVecData makeMoveVec;    // [string | null, SuiArgument[]]
    ...
    public static class MakeMoveVecData {
        ...
        private List<SuiArgument> elements;
    }
}
