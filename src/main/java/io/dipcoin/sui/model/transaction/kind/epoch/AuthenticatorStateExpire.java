...
package io.dipcoin.sui.model.transaction.kind.epoch;
...
/**
 * @author : Same
 * @datetime : 2025/6/27 18:19
 * @Description : AuthenticatorStateExpire response
 */
@Data
@Accessors(chain = true)
@JsonIgnoreProperties(ignoreUnknown = true)
public class AuthenticatorStateExpire extends SuiEndOfEpochTransactionKind {

    @JsonProperty("AuthenticatorStateExpire")
    private SuiAuthenticatorStateExpire authStateExpire;
