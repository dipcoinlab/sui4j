 ...
 * @Description : SplitCoins response
 */
...
public class SplitCoins extends SuiTransaction {

    @JsonProperty("SplitCoins")
    private SplitCoinsData splitCoins;  // [SuiArgument, SuiArgument[]]
    ...
    public static class SplitCoinsData {
        private SuiArgument coin;
        private List<SuiArgument> amounts;
    }
}
