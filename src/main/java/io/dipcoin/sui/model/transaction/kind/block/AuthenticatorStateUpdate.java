...
import io.dipcoin.sui.model.sui.SuiActiveJwk;
...
/**
 * @author : Same
 * @datetime : 2025/6/27 15:41
 * @Description : AuthenticatorStateUpdate response
 */
@Data
...
public class AuthenticatorStateUpdate extends TransactionBlockKind {
    ...
    private List<SuiActiveJwk> newActiveJwks;
