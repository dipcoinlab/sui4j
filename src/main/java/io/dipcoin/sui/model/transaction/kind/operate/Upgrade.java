...
/**
 * @author : Same
 * @datetime : 2025/6/27 22:15
 * @Description : Upgrade response
 */
...
public class Upgrade extends SuiTransaction {

    @JsonProperty("Upgrade")
    private UpgradeData upgrade;    // [string[], string, SuiArgument]
    ...
    public static class UpgradeData {
        ...
        private SuiArgument upgradeTicket;
    }
}
